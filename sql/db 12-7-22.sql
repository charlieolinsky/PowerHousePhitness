...
--
-- Host: localhost
-- Generation Time: Dec 07, 2022 at 08:10 PM
...
(275, 30, NULL, NULL, '0.00', '2022-12-05'),
(2474, 30, NULL, NULL, '12.00', '2022-12-05'),
(2898, 33, NULL, NULL, '36.00', '2022-12-06'),
...
(4512, 32, NULL, NULL, '20.00', '2022-12-05'),
(4860, 33, NULL, NULL, '10.00', '2022-12-05'),
(4977, 33, NULL, NULL, '4.50', '2022-12-05'),
(5160, 33, NULL, NULL, '12.00', '2022-12-05'),
(5413, 33, NULL, NULL, '30.00', '2022-12-05'),
(5571, 33, NULL, NULL, '17.97', '2022-12-06'),
(6351, 17, NULL, NULL, '30.00', '2022-12-05'),
(7221, 30, NULL, NULL, '8.00', '2022-12-05'),
(8956, 17, NULL, NULL, '32.00', '2022-12-05'),
(9148, 33, NULL, NULL, '0.00', '2022-12-05'),
...
(19, 'Basketball - Large', 'This is a size 7 basketball with 29.5\" circumference', '../UI/images/prod_images/basketball.jpg', '5.50', 14, 1, '10/23/2022', '20.99', 1),
...
(22, 'Racquetball Racquet', 'This is a pack of 4 racquets ', '../UI/images/prod_images/racquetballracket.jpg', '6.50', 5, 3, '11/5/22', '10.00', 1),
...
(25, 'Jump Rope', 'This is a standard sized jump rope', '../UI/images/prod_images/jumprope.jpg', '2.99', 11, 2, '11/21/22', '7.50', 3),
...
(31, 'Badminton Birdie ', 'Birdies come in a pack of 4 ', '../UI/images/prod_images/birdie.jpg', '3.00', 3, 3, '9/30/22', '5.00', 9),
...
(35, 'Kickball', 'This is a rubber kickball', '../UI/images/prod_images/kickball.jpg', '4.00', 0, 1, '11/2/22', '7.00', 3),
...
(100, 30, '33 Fair Way', '', 'Poughkeepsie', 'NY', '12603', 0),
(101, 33, '33 Fair Way', '', 'Poughkeepsie', 'NY', '12603', 0),
(102, 33, '33 Fair Way', '', 'Poughkeepsie', 'NY', '12603', 0),
(103, 33, '33 Fair Way', '', 'Poughkeepsie', 'NY', '12603', 0),
(104, 33, '33 Fair Way', '', 'Poughkeepsie', 'NY', '12603', 0),
(105, 33, '33 Fair Way', '', 'Poughkeepsie', 'NY', '12603', 0),
(106, 33, '33 Fair Way', '', 'Poughkeepsie', 'NY', '12603', 0);
...
(36, 'Phil@gmail.com', '$2y$12$xE5gL4zAOwRftpNBmAzPUuMyDgbo43SI37I8Bn2mhd8OXwM7awjwa', 1, 'Phil', 'Jim', NULL);
...
--
ALTER TABLE `prod_data`
  MODIFY `PROD_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=294;

--
-- AUTO_INCREMENT for table `user_address`
--
ALTER TABLE `user_address`
  MODIFY `ADD_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=107;
