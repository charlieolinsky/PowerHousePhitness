...
--
-- Host: localhost
-- Generation Time: Nov 08, 2022 at 02:01 AM
...
INSERT INTO `prod_data` (`PROD_ID`, `prod_name`, `prod_desc`, `prod_image`, `prod_price`, `prod_quantity`, `VENDOR_ID`, `prod_date_purchased`, `prod_purchase_cost`, `is_rented`) VALUES
(19, 'Basketball - Large', 'This is a regulation sized basketball ', '../UI/images/prod_images/basketball.jpg', 5, 6, 1, '10/23/2022', 20.99, 0),
(20, 'Basketball-Small', '*Basketball Description*', '../UI/images/prod_images/basketball-small.jpg', 5, 6, 1, '', 15.99, 0),
(21, 'Soccer Ball', '*Soccer Ball Description', '../UI/images/prod_images/soccerball.jpg', 5, 3, 1, '', 19.99, 0),
(22, 'Racquetball Racquet', '*Racquetball Description*', '../UI/images/prod_images/racquetballracket.jpg', 3.5, 6, 2, '', 10, 0),
(23, 'Racquetballs', '*Raquetball Description*', '../UI/images/prod_images/racquetballs.jpg', 1, 4, 2, '', 5, 0),
(24, 'Football', '*Football Description*', '../UI/images/prod_images/football.jpg', 5, 4, 1, '', 20.99, 0),
(25, 'Jump Rope', '*Jump Rope Description*', '../UI/images/prod_images/jumprope.jpg', 2, 3, 3, '', 7.5, 0),
(26, 'Volleyballs', '*Volleyball Description*', '../UI/images/prod_images/volleyball.jpg', 5, 4, 1, '', 15.99, 0),
(27, 'Frisbee', '*Frisbee Description*', '../UI/images/prod_images/frisbee.jpg', 1, 2, 3, '', 12, 0),
(30, 'Badminton Raquette ', 'This is a Raquette', '', 3, 4, 2, '10/28/22', 7, 0),
(31, 'Badminton Birdie ', 'This is a pack of 4 ', '', 2.5, 10, 3, '9/30/22', 5, 0),
(32, 'Resistance Band', 'This is a medium resistance', '', 2, 10, 2, '10/29/22', 8.5, 0),
(33, 'Stop Watch', '', '../UI/images/prod_images/stopwatch.jpg', 1, 5, 2, '', 4.5, 0),
(34, 'Kan Jam', 'This is a Kan Jam Set', '../UI/images/prod_images/kanjam.jpg', 10.99, 2, 3, '10/30/22', 25, 0),
(35, 'Kickball', 'This is a kickball', '../UI/images/prod_images/kickball.jpg', 3.5, 3, 1, '11/2/22', 7, 0);
...
--
ALTER TABLE `prod_data`
  MODIFY `PROD_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=120;
